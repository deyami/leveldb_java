...
public class TwoLevelIterator extends Iterator {
     ...
     * Construction
     *
     * @param index_iter     (outer iterator) is wrappered to be IteratorWrapper
     * @param block_function Guess: get inner iterator according to outer iterator's value
     *                       from a cache
     * @param arg
     * @param options        (inner iterator) is set as null
     */
